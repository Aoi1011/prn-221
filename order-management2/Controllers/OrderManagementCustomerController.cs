...
namespace order_management2.Controllers
{
    ...
    [ApiController]
    public class OrderManagementCustomerController : ControllerBase
    {
        private readonly OrderManagementContext _context;

        public OrderManagementCustomerController(OrderManagementContext context)
        {
            _context = context;
        }

        // GET: api/OrderManagementCustomer
        [HttpGet]
        ...
        // GET: api/OrderManagementCustomer/5
        [HttpGet("{id}")]
        ...
        // PUT: api/OrderManagementCustomer/5
        ...
        // DELETE: api/OrderManagementCustomer/5
        [HttpDelete("{id}")]
